        ...
        <div className="relative z-10 space-y-6">
          ...
          <blockquote className="border-l-2 border-background/30 pl-5">
            <p className="text-base leading-relaxed text-background/60">
              Protecting access to critical infrastructure and platform operations. Enter your
              identity to initiate secure key verification and resume management.
            </p>
          </blockquote>
        </div>
        ...
        <div className="w-full max-w-sm space-y-10">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Enter your administrative identity to receive a verification code.
            </p>
          </div>
