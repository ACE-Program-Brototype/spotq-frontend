          ...
          <div className="rounded-xl border border-[#eadfd8] bg-white p-6 shadow-[0_8px_30px_rgba(45,30,20,0.04)] sm:p-8">
            {selectionData ? (
              <div>
                ...
                {selectionData.restaurants.length === 0 ? (
                  <div className="py-8 text-center text-sm text-[#756c66] bg-neutral-50 rounded-xl border border-dashed border-[#eddcd4] mb-6">
                    <Building2 className="size-8 text-neutral-400 mx-auto mb-2 opacity-60" />
                    <p className="font-medium text-[#1c1714]">No active restaurant memberships</p>
                    <p className="text-xs text-[#756c66] mt-1">
                      No accessible restaurants were found for your staff account.
                    </p>
                  </div>
                ) : (
                  <div className="space-y-3 mb-6 max-h-[300px] overflow-y-auto pr-1">
                    {selectionData.restaurants.map((restaurant) => {
                      ...
                      const isInactive = restaurant.status !== "ACTIVE";
                      ...
                      return (
                        <button
                          ...
                          className={`w-full flex items-center justify-between p-3.5 rounded-xl border transition-all text-left ${
                            isInactive
                              ? "border-[#eddcd4]/60 bg-neutral-50/70 opacity-60 cursor-not-allowed"
                              : isSelected
                                ? "border-[#b84b00] bg-[#fffaf5] shadow-xs cursor-pointer"
                                : "border-[#eddcd4] bg-white hover:border-[#d9cbc2] hover:bg-[#faf7f5] cursor-pointer"
                          }`}
                        >
                          <div className="flex items-center gap-3 min-w-0">
                            ...
                            <div className="min-w-0">
                              ...
                              <div className="flex items-center gap-2 mt-0.5">
                                ...
                                {isInactive && (
                                  <span className="inline-block px-1.5 py-0.5 text-[10px] font-semibold bg-neutral-200 text-neutral-600 border border-neutral-300 rounded">
                                    Deactivated
                                  </span>
                                )}
                              </div>
                ...
                <Button
                  type="button"
                  disabled={
                    !selectedRestaurantId || isSelecting || selectionData.restaurants.length === 0
                  }
